...
export default function Signup() {
  ...
  const [creadentials, setCredentials] = useState({name:"",email:"",password:"",geolocation:""})
  
  const handleSubmit = async(e) =>{
    e.preventDefault();
    console.log(JSON.stringify({name: creadentials.name, email: creadentials.email, password: creadentials.password, location: creadentials.geolocation}))
        ...
        <div className='container'>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name='geolocation' value={creadentials.geolocation} onChange={onChange} id="exampleInputPassword1" />
                </div>
